...
const AltScoreItem = ({ homeTeam, awayTeam,competition, homeImage, awayImage, time, homeScore, awayScore, homeRedCard = 0, awayRedCard = 0, status, isActive }: WidgetProps) => {
    if (status === 'live') {
    return (
        <Component>
            <CompRow>
                <LabelComp>31 March 2019</LabelComp>
            <LabelCompBlock>
          <LabelCompIcon src='https://images.fotmob.com/image_resources/logo/leaguelogo/47.png' alt='icon' width={16} height={16} />
          <LabelComp>{competition}</LabelComp>
                </LabelCompBlock>
                </CompRow>
        <Content>
          <Left>
