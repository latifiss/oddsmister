...
const HomeScoreBoxEnded = styled.div`
    ...
    width: 24px;
    height: 24px;
    background-color: var(--oi-tuatara);
`
...
const ScoreItem = ({ homeTeam, awayTeam, homeImage, awayImage, time, homeScore, awayScore, homeRedCard = 0, awayRedCard = 0, status, isActive }: WidgetProps) => {
    if (status === 'live') {
    return (
      <Component>
        <Content>
